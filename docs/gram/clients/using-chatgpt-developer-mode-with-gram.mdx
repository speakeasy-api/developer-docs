...
When combined with [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) servers hosted on [Gram](/docs/gram/quickstart), you can give ChatGPT access to your APIs and tools in just a few minutes.
