...
When combined with [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) servers hosted on [Gram](/docs/gram/gram-quickstart), you can give ChatGPT access to your APIs and tools in just a few minutes.
...
[Environments](/docs/gram/concepts/environments) store API keys and configurations separate from your toolset logic.
...
<video width="600" controls>
  <source src="/assets/docs/gram/videos/chatgpt-acme-todo-demo.mp4" type="video/mp4" />
