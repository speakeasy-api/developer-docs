...
- An MCP client (This guide covers VS Code with Copilot, Windsurf, and Amp. For Cursor, see the [dedicated Cursor guide](/docs/gram/clients/using-cursor-with-gram-mcp-server). For Claude Desktop, see the [dedicated Claude Desktop guide](/docs/gram/clients/using-claude-desktop-with-gram-mcp-server).)
...
For detailed instructions on connecting Cursor to Gram-hosted MCP servers, including using the Gram CLI for quick setup, see the [dedicated Cursor guide](/docs/gram/clients/using-cursor-with-gram-mcp-server).
