...
Connect the Entrypoint node to the Agent node, then connect the Agent node to the Output. Click the Output Value, select **Agent** for the Node type, and set the Output name to `Text`.
