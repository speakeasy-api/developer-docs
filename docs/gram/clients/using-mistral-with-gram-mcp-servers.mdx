...
When combined with [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) servers hosted on [Gram](/docs/gram/gram-quickstart), you can give Mistral access to your APIs and tools in just a few minutes. 
...
3. Fill in the details:
   ...
   - For Authentication, select **API Token Authentication** and add your [Gram API key](/docs/gram/concepts/api-keys).
...
<video width="600" controls>
  <source src="/assets/docs/gram/videos/mistral-acme-todo.mp4" type="video/mp4" />
