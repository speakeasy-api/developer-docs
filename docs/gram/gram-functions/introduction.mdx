...
You can write Gram Functions using the [Gram Functions Framework](/docs/gram/gram-functions/functions-framework) or the official [Gram MCP SDK](/docs/gram/gram-functions/mcp-sdk).
