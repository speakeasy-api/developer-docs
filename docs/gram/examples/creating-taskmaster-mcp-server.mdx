...
On the [Gram dashboard](https://app.getgram.ai), click your username at the bottom-left corner and then open the projects dropdown. Select **+ New Project**, enter a project name, and click **Submit**.
