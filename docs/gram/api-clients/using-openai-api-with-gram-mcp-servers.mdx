...
- **The [Agents SDK](/docs/gram/api-clients/using-openai-agents-sdk-with-gram-mcp-servers):** An advanced agent framework with sessions, handoffs, and persistent context that is perfect for complex conversational workflows.
...
If you need more advanced features like persistent conversations or complex workflows, consider the [Agents SDK guide](/docs/gram/api-clients/using-openai-agents-sdk-with-gram-mcp-servers), or try [ChatGPT Connectors](/docs/gram/clients/using-chatgpt-developer-mode-with-gram) for a web UI solution.
