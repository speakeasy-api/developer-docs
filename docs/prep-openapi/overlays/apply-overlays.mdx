...
<img src="./assets/overlays-1.png" alt="Screenshot of the terminal after running speakeasy configure sources." />

### 3. Add Overlay:

<img src="./assets/overlays-2.png" alt="Screenshot of the terminal prompting user to add an overlay." />

### 4. Provide overlay file path:

<img src="./assets/overlays-3.png" alt="Screenshot of the terminal showing a successful overlay application." />

### 5. Provide location for the output build: 

<img src="./assets/overlays-4.png" alt="Screenshot of the terminal showing completed setup." />
