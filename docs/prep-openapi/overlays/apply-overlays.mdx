...
import overlays1Image from '@/content/docs/assets/overlays-1.png'
import overlays2Image from '@/content/docs/assets/overlays-2.png'
import overlays3Image from '@/content/docs/assets/overlays-3.png'
import overlays4Image from '@/content/docs/assets/overlays-4.png'
