...
<h3>Remove unused components</h3>

<p>Remove unused components from the OpenAPI document, preventing them from being included in the generated SDK.</p>

<pre><code class="language-yaml">workflowVersion: 1.0.0
...
<p>Keep or remove the specified operations from the OpenAPI document.</p>
...
<p>Clean up the OpenAPI document, making it more readable and compliant with various parsing tools.</p>
...
<p>Changes the order of keys at various levels in the document, formatting it to be more human-readable.</p>
