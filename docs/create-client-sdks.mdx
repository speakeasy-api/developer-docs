...
import quickstart1Image from '@/content/docs/assets/create-sdks/quickstart-1.png'
import quickstart2Image from '@/content/docs/assets/create-sdks/quickstart-2.png'
import quickstart3Image from '@/content/docs/assets/create-sdks/quickstart-3.png'
import quickstart4Image from '@/content/docs/assets/create-sdks/quickstart-4.png'
import quickstart5Image from '@/content/docs/assets/create-sdks/quickstart-5.png'
import studio1Image from '@/content/docs/assets/create-sdks/studio-1.png'
...
<Screenshot 
  ...
  image={{
    ...
    alt: "Screenshot of the terminal with optional parameters."
  }}
/>
