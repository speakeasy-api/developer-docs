...
![Screenshot of SnippetAI's chat interface](/assets/docs/snippet-ai/snippet-ai.png)
...
![Screenshot of SnippetAI with generated code snippets](/assets/docs/snippet-ai/snippet-ai-demo.png)
...
image={{
    src: '/assets/docs/snippet-ai/snippet-ai-docs-highlight.png',
...
<Screenshot variant="web"
image={{
    src: '/assets/docs/snippet-ai/snippet-ai-prereqs-page.png',
...
<Screenshot variant="web"
image={{
    src: '/assets/docs/snippet-ai/snippet-ai-create-token-modal.png',
...
<Screenshot variant="web"
image={{
    src: '/assets/docs/snippet-ai/snippet-ai-setup-guide.png',
