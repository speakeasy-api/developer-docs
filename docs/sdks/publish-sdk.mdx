...
<Table 
  data={[
    ...
    { language: "Python", manager: "PyPI", prerequisites: "[API tokens](https://pypi.org/help/#apitoken) or [Trusted publishing](https://docs.pypi.org/trusted-publishers/)", notes: "Trusted publishing with OIDC is recommended. See the [setup instructions](#python-pypi-trusted-publishing) below." },
