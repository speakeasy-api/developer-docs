...
<Table
  data={[
    ...
    },
    {
      ...
      notes:
        "CLI targets use GoReleaser for cross-platform binary builds rather than `speakeasy configure publishing`. Binaries are distributed via GitHub Releases and generated install scripts. [Learn more](/docs/cli-generation/distribute-cli).",
    },
  ]}
  columns={[
