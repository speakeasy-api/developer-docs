  ...
  tabs={[
    {
      label: "npm",
      language: "bash",
      code: `npm install @speakeasy-api/snippet-ai-react`,
    },
    {
      label: "yarn",
      language: "bash",
      code: `yarn add @speakeasy-api/snippet-ai-react`,
    },
    {
      label: "pnpm",
      language: "bash",
      code: `pnpm add @speakeasy-api/snippet-ai-react`,
    },
  ]}
/>
  ...
  data={[
    {
      ...
      type: "`string`",
      description:
        "Programming language for suggestion results (`typescript`, `python`, `go`, `java`, `csharp`, `php`)",
      default: "`typescript`",
    },
    {
      prop: "`toggleShortcut`",
