---
 ...
 description: "Discover recommended and optional customizations for the Speakeasy SDK pipeline to enhance the user experience."
---
...
2. **Contact Speakeasy support**: For enterprise customers with specific dependency requirements, contact [Speakeasy support](/support/enterprise-api-platform) to discuss custom solutions.
