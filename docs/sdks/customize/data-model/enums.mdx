  ...
  tabs={[
    {
      label: "TypeScript",
      language: "typescript",
      code: `type BackgroundColor = "red" | "green" | "blue" | Unrecognized<string>;`,
    },
    {
      label: "Go",
      language: "go",
...
green == BackgroundColor.of("green"); // true`,
},
    {
      label: "Ruby",
      language: "ruby",
      code: `# Known values are defined as constants
green = Shared::BackgroundColor::GREEN
green.known?   # => true
green.serialize # => "green"

# Open enums accept unknown values via deserialize
purple = Shared::BackgroundColor.deserialize("purple")
purple.known?   # => false
purple.serialize # => "purple"

# Equality works across known and unknown values
Shared::BackgroundColor.deserialize("green") == Shared::BackgroundColor::GREEN # => true`,
}
]}
/>
