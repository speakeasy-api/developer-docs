...
| File create/delete/rename | Not supported                | Supported                                                        |
...
<Callout title="Current limitations" type="warning">
  Patch files currently modify the contents of generated files only. Diffs that create, delete, or rename files are rejected, and disk-only files (manually authored or [`.genignore`d](/docs/sdks/customize/code/custom-code/genignore)) are not visible to the patch pipeline.
</Callout>
