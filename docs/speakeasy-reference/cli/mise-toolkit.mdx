---
title: "Using Speakeasy CLI with mise toolkit"
  ...
  tabs={[
    {
      label: "macOS",
      language: "bash",
      code: `# Install mise using Homebrew
brew install mise`,
    },
    {
      label: "Linux",
      language: "bash",
      code: `# Install mise using the install script
curl https://mise.jdx.dev/install.sh | sh`,
    },
    {
      label: "Windows",
      language: "bash",
      code: `# Install mise using winget
  ...
  tabs={[
    {
      label: "Aqua",
      language: "bash",
      code: `# Install using the aqua backend (recommended)
mise use aqua:speakeasy-api/speakeasy`,
    },
    {
      label: "UBI",
      language: "bash",
      code: `# Install using the ubi backend
...
- [Customize your SDK](/docs/sdks/customize/basics)
