---
title: "Speakeasy Terraform provider support matrix"
...
<Table
  data={[
    ...
    },
    {
      ...
      docs: "[Docs link](/docs/terraform/customize-terraform/provider-configuration#custom-resources-data-sources-actions-or-functions)"
    }
  ]}
  columns={[
