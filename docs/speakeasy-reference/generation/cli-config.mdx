  ...
  data={[
    {
      ...
      default: "false",
      description:
        "Enable custom code regions that allow hand-written code to be inserted into generated files. Marked regions are preserved across regenerations. See [custom code regions](/docs/customize/code/code-regions/overview) for details.",
    },
  ]}
  columns={[
    { key: "name", header: "Name" },
