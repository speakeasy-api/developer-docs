...
<Table
  data={[
    ...
    },
    {
      ...
      default: "openapi",
      description:
        "Assigns Gradle `rootProject.name`, which names the Gradle build. See [Gradle Naming](https://docs.gradle.org/current/userguide/multi_project_builds.html#naming_recommendations).",
    },
  ]}
  columns={[
...
/>
## Base package name This package will be where the primary SDK class is located
(and sub-packages will hold various types of associated generated classes):
```yaml java: packageName: com.mycompany.sdk ```
...
<Table
  data={[
    {
      property: "flattenGlobalSecurity",
      description:
  ...
  data={[
    {
      ...
      required: "false",
      default: "true",
      description: "Determines if index modules are generated.",
    },
    {
      name: "moduleFormat",
      required: "false",
