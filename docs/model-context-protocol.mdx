...
[Claude][claude-desktop] desktop app or [Cursor][cursor] code editor. The full list of clients is available [here](https://modelcontextprotocol.io/clients).
...
<Callout title="Temporary restriction" variant="info">
...
[Overlays][overlays] are a convenient way to introduce the `x-speakeasy-mcp`
