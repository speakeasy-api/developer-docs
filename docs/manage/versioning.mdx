...
import labelsLocationImage from '@/content/docs/assets/labels-location.png'
import versioning1Image from '@/content/docs/assets/versioning-1.png'
import versioning2Image from '@/content/docs/assets/versioning-2.png'
