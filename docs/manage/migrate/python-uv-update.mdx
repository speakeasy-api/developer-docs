...
description: "Migration to uv for Python dependency management"
---
...
`uv` is designed as a faster, more modern replacement for `poetry`, with strong support for Python packaging standards and significantly improved performance for dependency resolution and installation.

## Poetry remains available

`poetry` continues to be supported, and SDK producers who prefer it can opt in via generator configuration.
