  ...
  data={[
    {
      ...
      description: "The security configuration for the webhooks.",
    },
  ]}
  columns={[
  ...
  data={[
    {
      ...
      type: "`string`",
      description:
        "The type of security to use for the webhooks. Valid values are `signature` and `custom`.",
    },
    {
      property: "`headerName`",
      type: "`string`",
    ...
    {
      property: "`signatureTextEncoding`",
      type: "`string`",
      description:
        "The text encoding of the signature. Applicable to `type: signature`.",
    },
    {
      property: "`algorithm`",
      type: "`string`",
      description:
        "The algorithm to use for the signature. Valid values are: `hmac-sha256`.",
    },
  ]}
  columns={[
    { key: "property", header: "Property" },
