  ...
  tabs={[
    {
      label: "TypeScript",
      language: "typescript",
      code: `export class SDK extends ClientSDK {
    ...
    },
    {
      label: "Go",
      language: "go",
      code: `func (s *SDK) GetPayment(ctx context.Context, id string) (*components.Payment, error) {}`,
    },
    {
      label: "C#",
      language: "csharp",
      code: `public async Task<Payment> GetPaymentAsync(string id){}`,
    },
    {
      label: "PHP",
      language: "php",
      code: `public function getPayment(string $id, ?Options $options = null): Payment`,
    },
    {
      label: "Ruby",
      language: "ruby",
      code: `sig { params(id: ::String).returns(Payment) }
def get_payment(id:)`,
    },
  ]}
/>
...
<CodeWithTabs
  tabs={[
    {
      label: "TypeScript",
      language: "typescript",
      code: `class SDK extends ClientSDK {
  ...
  class HTTPMetadata:
      ...
      },
    {
      label: "Go",
      language: "go",
        code: `func (s *SDK) GetPayment(ctx context.Context, id string) (*operations.GetPaymentResponse, error) {}
  ...
  type HTTPMetadata struct {
    ...
    },
    {
      label: "C#",
      language: "csharp",
      code: `Task<GetPaymentResponse> GetPaymentAsync(string id);
