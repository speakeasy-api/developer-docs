...
import combinedSpecImage from '@/content/docs/assets/code-samples/combined-spec.png'
import combinedSpecDetailsImage from '@/content/docs/assets/code-samples/combined-spec-details.png'
import automaticCodeSamplesImage from '@/content/docs/assets/code-samples/automatic-code-samples-url-unavailable.png'
