Since no changes are required for this documentation file, I will provide the original content without any modifications:
...
<div data-screenshot data-darkened>
  <img src="../assets/code-samples/combined-spec.png" alt="Screenshot of the dashboard showing a Combined Spec." />
</div>

<div data-screenshot data-darkened>
  <img src="../assets/code-samples/combined-spec-details.png" alt="Screenshot of the dashboard showing Combined Spec details." />
</div>
...
<div data-screenshot data-darkened>
  <img src="../assets/code-samples/automatic-code-samples-url-unavailable.png" alt="Automatic code sample URLs not available." />
</div>
...
<div data-callout data-title="Alternatives to configuring sdk-publish.yaml:" data-variant="warning">
  <p>
