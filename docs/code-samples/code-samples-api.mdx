...
snippet, add a highlight.js theme to the project. Themes can be 
...
<h3 class="_tracking-tight _text-slate-900 dark:_text-white _mt-10 _text-h4-mobile md:_text-h4">Retrieve usage snippets</h3>
...
<h4 class="_tracking-tight _text-slate-900 dark:_text-white _mt-10 _text-h5-mobile md:_text-h5">Query Parameters</h4>

<div class="[&>table]:table-auto mt-6">
...
<h4 class="_tracking-tight _text-slate-900 dark:_text-white _mt-10 _text-h5-mobile md:_text-h5">Example Request</h4>
...
<h4 class="_tracking-tight _text-slate-900 dark:_text-white _mt-10 _text-h5-mobile md:_text-h5">Example Response</h4>
