...
import configurePublishingImage from '@/content/docs/assets/publish-sdks/configure-publishing.png'
import configureTokenImage from '@/content/docs/assets/publish-sdks/configure-token.png'
import publishingSuccessImage from '@/content/docs/assets/publish-sdks/publishing-success.png'
import publishingDispatchImage from '@/content/docs/assets/publish-sdks/publishing-dispatch.png'
import publishingOverviewImage from '@/content/docs/assets/publish-sdks/publishing-overview.png'
import setPublishingSecretsImage from '@/content/docs/assets/publish-sdks/set-publishing-secrets.png'
import pendingReleaseImage from '@/content/docs/assets/publish-sdks/pending-release.png'
...
<Screenshot 
  variant="cli"
  image={{
    src: configureTokenImage,
    alt: "Screenshot of the terminal prompting the user for an NPM token."
  }}
/>
...
<Screenshot 
  variant="cli"
  image={{
    src: publishingSuccessImage,
    alt: "Screenshot of the terminal after succesfully running Speakeasy configure publishing."
  }}
/>
...
<Screenshot 
  variant="cli"
  image={{
    src: publishingDispatchImage,
    alt: "Screenshot of manually kicking off publishing in Github Actions."
  }}
/>
