...
By default, all tests will be generated into a single file related to the main SDK class for example `sdk.test.ts` or `test_sdk.py`. This can be configured by adding a `x-speakeasy-test-group` extension to the workflow which will determine which tests will be grouped together in separate test files.
...
<div data-step='paths[/pet].put.operationId'>
...
<div data-step='paths[/pet].put.requestBody'>
...
<div data-step='components.schemas.Pet.required'>
...
<div data-step='components.schemas.Pet.id'>
...
<div data-step='components.schemas.Pet.name'>
...
<div data-step='components.schemas.Pet.photoUrls'>
...
<div data-step='paths[/pet].post.operationId'>
...
<div data-step='paths[/pet].post.requestBody'>
