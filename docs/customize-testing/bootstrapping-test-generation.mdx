...
Automatically generate tests for your SDKs. Speakeasy can bootstrap tests for all your operations including any new operations added in the future.
...
Tests are bootstrapped into a `.speakeasy/tests.arazzo.yaml` file in your SDK repo. Once the test exists it can be customized from that `.speakeasy/tests.arazzo.yaml` without being overwritten.
