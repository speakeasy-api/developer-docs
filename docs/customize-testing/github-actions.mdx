...
import testingRunImage from '@/content/docs/assets/configure-github/testing-run.png'
import testingCommentImage from '@/content/docs/assets/configure-github/testing-comment.png'
import prPatPart1Image from '@/content/docs/assets/configure-github/pr-pat-part1.png'
import prPatPart2Image from '@/content/docs/assets/configure-github/pr-pat-part2.png'
import prPatPart3Image from '@/content/docs/assets/configure-github/pr-pat-part3.png'
import prCreationTokenImage from '@/content/docs/assets/configure-github/pr-creation-token.png'
