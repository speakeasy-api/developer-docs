...
Open `src/gram.ts` and write your tools. You can add as many tools as you want, or leave it as-is to use the default tool. For more information on writing tools, see the [Gram Functions](/docs/mcp/build/gram-functions/introduction) documentation.
...
- [Learn more about the Gram Functions framework.](/docs/mcp/build/gram-functions/introduction)
