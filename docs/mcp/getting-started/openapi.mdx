...
[toolsets](/docs/mcp/reference/concepts/toolsets), which are curated collections of tools
...
With [tag-based tool filtering](/docs/mcp/build/hosting/tool-filtering) enabled, MCP clients can connect to a focused subset of the server's tools by selecting one or more tags. Tags can also be overridden later with [tool variations](/docs/mcp/reference/concepts/tool-variations#tags).
...
- [Improve tool names and descriptions](/docs/mcp/reference/concepts/tool-variations)
- [Filter tools by tag with tag-based tool filtering.](/docs/mcp/build/hosting/tool-filtering)
- [Add tools using the Gram TypeScript Framework.](/docs/mcp/getting-started/typescript)
