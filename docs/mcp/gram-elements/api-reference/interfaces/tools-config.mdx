...
> `optional` **toolsRequiringApproval**: [`ToolsFilter`](/docs/mcp/gram-elements/api-reference/type-aliases/tools-filter)
...
> `optional` **toolsToInclude**: [`ToolsFilter`](/docs/mcp/gram-elements/api-reference/type-aliases/tools-filter)
