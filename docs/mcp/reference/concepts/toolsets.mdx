...
- Refine tool names and descriptions using Gram's [tool-variations](/docs/mcp/reference/concepts/tool-variations) feature to improve clarity and usability for the LLM.
