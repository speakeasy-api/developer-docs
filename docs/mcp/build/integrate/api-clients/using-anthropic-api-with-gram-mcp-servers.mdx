---
title: "How to connect Anthropic API to MCP"
description: "Learn how to connect Anthropic's Messages API to MCP servers, giving Claude models access to your APIs and tools."
sidebar:
  order: 2
---

Anthropic's [Messages API](https://docs.anthropic.com/en/api/messages) supports remote MCP servers through their MCP connector feature. This allows you to give Claude models direct access to your tools and infrastructure by connecting to [Gram-hosted MCP servers](/docs/mcp/getting-started#quickstart-guides).
