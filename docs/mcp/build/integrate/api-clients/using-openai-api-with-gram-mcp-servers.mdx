---
title: "How to connect OpenAI Responses API to MCP"
description: "Learn how to connect OpenAI's Responses API to MCP servers, giving GPT models access to your APIs and tools."
sidebar:
  order: 1
---
