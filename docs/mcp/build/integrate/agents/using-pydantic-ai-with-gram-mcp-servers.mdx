---
title: "How to connect Pydantic AI agents to MCP"
description: "Learn how to connect Pydantic AI agents to MCP servers, giving your agents access to your APIs and tools."
sidebar:
  order: 5
---

[Pydantic AI](https://ai.pydantic.dev/) supports MCP servers through the `pydantic-ai-mcp-client` library. This allows you to give your Pydantic AI agents direct access to your tools and infrastructure by connecting to [Gram-hosted MCP servers](/docs/mcp/getting-started#quickstart-guides).
...
For authenticated servers, you'll need an API key. [Generate an API key](/docs/mcp/secure/api-keys) in the **Settings** tab. For an in-depth guide to how Gram works and to creating a Gram-hosted MCP server, check out our [introduction to Gram](/docs/mcp/introduction).
...
![Screenshot of the MCP Inspector connecting to a Gram-hosted MCP server](/assets/docs/gram/img/guides/mcp-debugger.png)
...
Ready to build your own MCP server? [Try Gram today](/book-demo) and see how easy it is to turn any API into agent-ready tools that work with Pydantic AI and all major AI frameworks.
