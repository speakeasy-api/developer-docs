---
title: "How to connect OpenAI Agents SDK to MCP"
description: "Learn how to connect OpenAI's Agents SDK to MCP servers, building intelligent agents with access to your APIs and tools."
---
...
When combined with [Gram-hosted MCP servers](/docs/mcp/getting-started#quickstart-guides), the Agents SDK enables you to build sophisticated agents that can interact with your APIs, databases, and other services through natural language conversations with persistent context.
...
- **The [Responses API](/docs/mcp/build/integrate/api-clients/using-openai-api-with-gram-mcp-servers):** An API with a simple request-response pattern, ideal for basic tool calling and quick integrations.
...
If you're unsure which approach fits your needs, start with the [Responses API guide](/docs/mcp/build/integrate/api-clients/using-openai-api-with-gram-mcp-servers) for simpler implementations or try [ChatGPT Connectors](/docs/mcp/build/integrate/clients/using-chatgpt-developer-mode-with-gram) for a web UI solution.
...
- A [Taskmaster MCP server](/docs/mcp/build/examples/creating-taskmaster-mcp-server) set up and configured
...
Follow the guide to [creating a Taskmaster MCP server](/docs/mcp/build/examples/creating-taskmaster-mcp-server), which walks you through:
...
<Callout title="Code Examples" type="info">
  ...
  server](/docs/mcp/build/examples/creating-taskmaster-mcp-server).
</Callout>
...
![Screenshot of the Gram Playground testing Taskmaster tools](/assets/docs/gram/img/guides/agents-sdk/gram-playground-taskmaster.png)
...
![Screenshot of the MCP Inspector connecting to a Taskmaster MCP server](/assets/docs/gram/img/guides/agents-sdk/mcp-debugger.png)
