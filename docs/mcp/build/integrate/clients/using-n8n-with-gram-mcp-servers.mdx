---
title: "How to connect n8n to MCP"
description: "Learn how to connect n8n to MCP servers to give your automation workflows access to your APIs and tools."
sidebar:
  order: 6
---
...
![Screenshot of the Gram dashboard showing the New Project link](/assets/docs/gram/img/guides/n8n/gram-new-project.png)
...
![Screenshot of the upload your OpenAPI spec dialog](/assets/docs/gram/img/guides/n8n/upload-openapi-spec.png)

#### Step 2: Create a toolset

Give your toolset a name (for example, `Push Advisor`) and click **Continue**. 

![Screenshot of the create toolset dialog](/assets/docs/gram/img/guides/n8n/create-toolset.png)
...
![Screenshot of the configure MCP dialog](/assets/docs/gram/img/guides/n8n/configure-mcp.png)

Gram will create the toolset from the OpenAPI document.

Click **Toolsets** in the sidebar to view the Push Advisor toolset.

![Screenshot of the Gram dashboard showing the Push Advisor toolset](/assets/docs/gram/img/guides/n8n/toolset-created.png)
...
![Screenshot showing the fill for toolset dialog to automatically populate required variables](/assets/docs/gram/img/guides/n8n/fill-env-vars-toolset.png)
...
![Set server URL](/assets/docs/gram/img/guides/n8n/set-server-url.png)
...
You'll need an API key to use an authenticated server. [Generate an API key](/docs/mcp/secure/api-keys) in the **Settings** tab and copy it to the `GRAM_KEY` environment variable in place of `<your-key-here>`.
...
![Screenshot showing how to add a Chat Trigger node in n8n](/assets/docs/gram/img/guides/n8n/n8n-add-chat-trigger.png)
...
![Screenshot showing how to add an AI Agent node in n8n](/assets/docs/gram/img/guides/n8n/n8n-add-ai-node.png)
...
![Screenshot showing how to add a chat model in n8n](/assets/docs/gram/img/guides/n8n/n8n-adding-chat-model.png)
...
![Screenshot showing how to add the MCP Client tool](/assets/docs/gram/img/guides/n8n/n8n-add-mcp-client.png)
...
![Screenshot showing the MCP configuration in n8n](/assets/docs/gram/img/guides/n8n/n8n-configure-mcp.png)
...
![Screenshot showing the final chat interface with a user asking about pushing to production](/assets/docs/gram/img/guides/n8n/n8n-final-output.png)
