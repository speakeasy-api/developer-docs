---
title: "How to connect Claude Desktop to MCP"
description: "Learn how to connect Claude Desktop to MCP servers to give Claude access to your APIs and tools."
sidebar:
  order: 2
---
...
Before connecting Claude Desktop to a Taskmaster MCP server, you first need to create one. Follow our guide to [creating a Taskmaster MCP server](/docs/mcp/build/examples/creating-taskmaster-mcp-server).
