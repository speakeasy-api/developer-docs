---
title: "Using Zapier with Gram-hosted MCP servers"
---

[Zapier](https://zapier.com/) is a leading automation platform that connects thousands of apps. With the **MCP Client by Zapier** integration, you can connect Zapier to your [Gram-hosted MCP servers](https://www.speakeasy.com/blog/release-gram-beta), allowing you to trigger tools and actions on your MCP server directly from your Zapier workflows.
...
- A [Gram account](/docs/mcp/getting-started)
...
Before testing the trigger, open your chosen Slack channel and send a message that we can use for the remaining setup (for example, _"Should I push?"_). Then test the trigger, select that message from the recent records list, and click **Continue with selected record**.
...
Ready to build your own MCP server? [Try Gram today](/docs/mcp/getting-started) and see how easy it is to turn any API into agent-ready tools.
