---
title: "How to connect Cline to MCP"
description: "Learn how to connect Cline to MCP servers to give your AI coding assistant access to your APIs and tools in VS Code."
sidebar:
  order: 3
---
...
Before connecting Cline to a Taskmaster MCP server, you first need to create one. Follow our guide to [creating a Taskmaster MCP server](/docs/mcp/build/examples/creating-taskmaster-mcp-server).
...
![Screenshot showing the Cline MCP settings button](/assets/docs/gram/img/guides/mcp-installing-cline/cline-mcp-button.png)
...
![Screenshot showing the Cline MCP server list](/assets/docs/gram/img/guides/mcp-installing-cline/cline-installed-server.png)
...
![Screenshot showing Cline asking for permission to use the tool](/assets/docs/gram/img/guides/mcp-installing-cline/cline-tool-permission.png)
