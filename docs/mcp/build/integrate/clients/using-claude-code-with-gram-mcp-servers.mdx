---
title: "How to connect Claude Code to MCP"
description: "Learn how to connect Claude Code to MCP servers, giving Claude access to your APIs and tools directly from the terminal."
sidebar:
  order: 1
---
