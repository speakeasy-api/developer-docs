...
While the tools generated from your OpenAPI document handle basic CRUD operations, you can extend your MCP server with custom logic using [Gram Functions](/docs/mcp/build/gram-functions/introduction). This is useful for adding business logic that goes beyond simple API calls.
...
- [Claude Code](/docs/mcp/build/integrate/clients/using-claude-code-with-gram-mcp-servers)
- [Claude Desktop](/docs/mcp/build/integrate/clients/using-claude-desktop-with-gram-mcp-server)
- [Your IDE](/docs/mcp/build/integrate/clients/using-your-ide-with-gram-mcp-server)
- [Cline](/docs/mcp/build/integrate/clients/using-cline-with-gram-mcp-server)
