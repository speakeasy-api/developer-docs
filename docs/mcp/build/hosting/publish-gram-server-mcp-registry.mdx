...
<Callout title="Manual publishing" type="info">
  Future versions of Gram will automate this publishing process. These
  instructions are for manual publishing until that release, or if you prefer
  manual control.
</Callout>
...
- **A Gram-hosted MCP server:** If you don't have one, learn to create one in our [quickstart guide](/docs/mcp/getting-started#quickstart-guides).
...
<Callout title="Note" type="info">
  You can contact Gram using the chat support widget at the bottom right of your
  [Gram dashboard](https://app.getgram.ai/).
</Callout>
...
- Refine tool definitions and use [tool variations](/docs/mcp/reference/concepts/tool-variations) to help LLMs better understand and invoke them accurately
