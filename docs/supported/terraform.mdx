...
<Table
  data={[
    ...
    },
    {
      ...
      support: "✅ Full support",
      comments: "The provider includes a `server_url` variable, allowing it to be used with any API server. By default, this variable is set to the first entry in the `servers` field of your OpenAPI document."
    },
    {
