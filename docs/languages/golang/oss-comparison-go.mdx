...
<Table 
  data={[
    { feature: "**Version Support**", speakeasy: "✅ Go 1.14+", openapiGenerator: "⚠️ Variable support", oapiCodegen: "✅ Good compatibility", ogen: "⚠️ Newer Go versions" },
    { feature: "**Dependencies**", speakeasy: "✅ 3 deps", openapiGenerator: "❌ 1500+ deps, requires Java", oapiCodegen: "✅ No external deps", ogen: "✅ No external deps" },
    { feature: "**Go Idiomaticity**", speakeasy: "✅ Native Go patterns", openapiGenerator: "❌ Non-idiomatic", oapiCodegen: "✅ Simple patterns", ogen: "⚠️ Custom patterns" },
    { feature: "**Nil-safe Getters**", speakeasy: "✅ Built-in safety", openapiGenerator: "❌ No safety", oapiCodegen: "❌ No safety", ogen: "❌ Custom optionals" },
    { feature: "**Union Types**", speakeasy: "✅ Full support", openapiGenerator: "❌ No support", oapiCodegen: "⚠️ Limited support", ogen: "✅ Full support" },
    { feature: "**Enums**", speakeasy: "✅ Type-safe", openapiGenerator: "❌ Strings only", oapiCodegen: "✅ Type-safe", ogen: "✅ Type-safe" },
    { feature: "**Complex Numbers**", speakeasy: "✅ Big decimal", openapiGenerator: "❌ Basic types", oapiCodegen: "❌ Basic types", ogen: "❌ Basic types" },
    { feature: "**Error Handling**", speakeasy: "✅ Custom types", openapiGenerator: "⚠️ Generic errors", oapiCodegen: "⚠️ Basic errors", ogen: "✅ Good errors" },
    { feature: "**Retries**", speakeasy: "✅ Built-in", openapiGenerator: "❌ No support", oapiCodegen: "❌ No support", ogen: "❌ No support" },
    { feature: "**Pagination**", speakeasy: "✅ Built-in", openapiGenerator: "⚠️ Manual only", oapiCodegen: "⚠️ Manual only", ogen: "⚠️ Manual only" },
    { feature: "**Documentation**", speakeasy: "✅ Complete docs", openapiGenerator: "⚠️ Basic docs", oapiCodegen: "❌ Minimal docs", ogen: "⚠️ Basic docs" },
    { feature: "**CI/CD Integration**", speakeasy: "✅ GitHub Actions", openapiGenerator: "❌ Manual only", oapiCodegen: "❌ Manual only", ogen: "❌ Manual only" }
  ]}
  columns={[
...
<Table 
  data={[
    { name: "**Id**", type: "Pointer to **int64**", description: "", notes: "[optional]" },
    { name: "**Name**", type: "**string**", description: "", notes: "" },
    { name: "**Category**", type: "Pointer to **Category**", description: "", notes: "[optional]" },
    { name: "**PhotoUrls**", type: "**[]string**", description: "", notes: "" },
    { name: "**Tags**", type: "Pointer to **[]Tag**", description: "", notes: "[optional]" },
    { name: "**Status**", type: "Pointer to **string**", description: "pet status in the store", notes: "[optional]" }
  ]}
  columns={[
...
<Table 
  data={[
    { field: "`Category`", type: "*Category", required: ":heavy_minus_sign:", description: "N/A", example: "" },
    { field: "`ID`", type: "**int64*", required: ":heavy_minus_sign:", description: "N/A", example: "10" },
    { field: "`Name`", type: "*string*", required: ":heavy_check_mark:", description: "N/A", example: "doggie" },
    { field: "`PhotoUrls`", type: "[]*string*", required: ":heavy_check_mark:", description: "N/A", example: "" },
    { field: "`Status`", type: "*PetStatus", required: ":heavy_minus_sign:", description: "pet status in the store", example: "" },
    { field: "`Tags`", type: "[]Tag", required: ":heavy_minus_sign:", description: "N/A", example: "" }
  ]}
  columns={[
