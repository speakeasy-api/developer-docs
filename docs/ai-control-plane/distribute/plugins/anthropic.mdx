...
<Callout title="Why OTEL is required" type="info">
  ...
  when that setting is enabled, and it can be copied on to an external collector
  with [OTEL
  forwarding](/docs/ai-control-plane/org-admin/logging-and-telemetry/otel-forwarding).
</Callout>
