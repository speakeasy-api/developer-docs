...
Start here: [TypeScript functions](/docs/ai-control-plane/connect/sources/functions), then [Using the Functions Framework](/docs/ai-control-plane/connect/sources/functions/functions-framework), [Build and deploy](/docs/ai-control-plane/connect/sources/functions/build-deploy), [Tool annotations](/docs/ai-control-plane/connect/sources/functions/tool-annotations), and [Tool tags](/docs/ai-control-plane/connect/sources/functions/tool-tags).
