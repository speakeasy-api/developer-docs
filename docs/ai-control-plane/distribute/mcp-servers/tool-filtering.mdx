...
- Tag the tools that should be filterable. Tags come from [OpenAPI operation tags](/docs/ai-control-plane/connect/sources/openapi#tag-tools-for-filtering), [Functions tags](/docs/ai-control-plane/connect/sources/functions/tool-tags), or [tool variations](/docs/ai-control-plane/reference/concepts/tool-variations#tags).
...
- [Tag Functions tools](/docs/ai-control-plane/connect/sources/functions/tool-tags) with the top-level `tags` property.
