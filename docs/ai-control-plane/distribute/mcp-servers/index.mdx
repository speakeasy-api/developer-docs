...
- **Network access** — choose public routes, [Tailscale private access](/docs/ai-control-plane/distribute/tailscale), or both for each server. This is separate from visibility and authentication.
