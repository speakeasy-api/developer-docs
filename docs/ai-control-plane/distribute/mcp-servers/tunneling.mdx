...
Tunneling connects the platform to a private backend. To restrict the client-facing hosted URL to a tailnet, see [Tailscale private access](/docs/ai-control-plane/distribute/tailscale). These controls can be used together.
