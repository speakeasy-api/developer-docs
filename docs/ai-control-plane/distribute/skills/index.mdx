...
Once a skill is in use, skill insights estimate how much it actually helps agent sessions — efficacy scores, estimated time saved, and attributed session cost. See [Measuring skill efficacy](/docs/ai-control-plane/distribute/skills/measuring-skill-efficacy) for how the scoring works and how to interpret the results.
