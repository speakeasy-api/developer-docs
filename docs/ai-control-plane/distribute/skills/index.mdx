---
title: Skills
description: "Author, capture, scan, version, distribute, and measure the skills available to the project."
---
...
<Callout type="info">
  Viewing this page requires the `skill:read` scope. Adding, editing, or
  archiving a skill requires the `skill:write` scope. The default [Admin
  role](/docs/ai-control-plane/org-admin/roles-and-permissions) includes full
...
<Screenshot
  ...
  image={{
    ...
    darkSrc:
      "/assets/docs/ai-control-plane/distribute/skills/skills-list-dark.webp",
...
Speakeasy analyzes tool call results for prompt injection while a skill is active. Scanning requires an enabled Prompt Injection [risk policy](/docs/ai-control-plane/secure/risk-policies). Organization administrators can select **"Set up scanning"** or **"View policy"** from the configuration card at the top of the **Skills** page.

If the current version has a finding, a **Prompt injection flagged** warning appears at the top of the skill detail page. Select **"Show findings"** to review the detection rule, confidence, and description. The warning does not display the raw tool call result.
...
<Screenshot
  url="app.speakeasy.com"
  image={{
    src: "/assets/docs/ai-control-plane/distribute/skills/skill-prompt-injection-findings.webp",
    darkSrc:
      "/assets/docs/ai-control-plane/distribute/skills/skill-prompt-injection-findings-dark.webp",
    alt: "A skill detail page with an expanded Prompt injection flagged warning listing the rule, confidence, and description for each finding",
  }}
/>
...
<Screenshot
  ...
  image={{
    ...
    darkSrc:
      "/assets/docs/ai-control-plane/distribute/skills/skill-detail-dark.webp",
...
<Screenshot
  ...
  image={{
    ...
    darkSrc:
      "/assets/docs/ai-control-plane/distribute/skills/skill-version-diff-dark.webp",
...
<Screenshot
  ...
  image={{
    ...
    darkSrc:
      "/assets/docs/ai-control-plane/distribute/skills/plugin-skills-dark.webp",
...
<Screenshot
  ...
  image={{
    ...
    darkSrc:
      "/assets/docs/ai-control-plane/distribute/skills/skill-shared-dark.webp",
...
<Screenshot
  ...
  image={{
    ...
    darkSrc:
      "/assets/docs/ai-control-plane/distribute/skills/skill-insights-dark.webp",
