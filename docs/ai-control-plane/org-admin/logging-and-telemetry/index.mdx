...
- **Agent Session Capture** captures user prompts and assistant responses from supported coding agents. Captured sessions appear in [Agent Sessions](/docs/ai-control-plane/observe/agent-sessions).
