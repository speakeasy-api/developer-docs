...
Sessions come from instrumented device agents such as Claude Code, Cursor, and Codex, and from provider imports when [AI Integrations](/docs/ai-control-plane/org-admin/ai-integrations) are connected: claude.ai chats, ChatGPT conversations, and Codex cloud web tasks all appear here as sessions.
