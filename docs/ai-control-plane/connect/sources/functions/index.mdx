...
[MCP servers](/docs/ai-control-plane/distribute/mcp-servers) are assembled from these tools later in the Speakeasy dashboard.
...
- [Choose which tools a server exposes](/docs/ai-control-plane/reference/concepts/tool-definitions#choosing-which-tools-a-server-exposes)
