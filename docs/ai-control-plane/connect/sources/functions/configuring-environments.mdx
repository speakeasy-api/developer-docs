...
To attach an environment to your Function, first ensure you have [created an environment](/docs/ai-control-plane/distribute/environments) with the configuration values you want to attach.
