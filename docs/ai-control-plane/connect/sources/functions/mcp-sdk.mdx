...
description: "Learn how to use the Speakeasy MCP SDK wrapper for advanced tool development and MCP protocol features."
---

## Overview

The Speakeasy MCP SDK wrapper provides low-level access to MCP features. This allows you to deploy an MCP server built using the [official MCP TypeScript SDK](https://github.com/modelcontextprotocol/typescript-sdk) as a Function.
