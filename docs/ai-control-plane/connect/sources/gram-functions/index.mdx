...
You can write Gram Functions using the [Gram Functions Framework](/docs/ai-control-plane/connect/sources/gram-functions/functions-framework) or the official [Gram MCP SDK](/docs/ai-control-plane/connect/sources/gram-functions/mcp-sdk).
...
Follow the [Build and deploy](/docs/ai-control-plane/connect/sources/gram-functions/build-deploy) guide to learn more.
...
MCP servers are created from [toolsets](/docs/ai-control-plane/reference/concepts/toolsets) later in the Gram dashboard. Tools can also be created directly from OpenAPI documents.
