...
- **`annotations`(optional):** Behavior hints for AI models and clients (see [Tool annotations](/docs/ai-control-plane/connect/sources/gram-functions/tool-annotations))
...
For more details on configuring and managing environment variables in Gram Functions, see [Configuring environments](/docs/ai-control-plane/connect/sources/gram-functions/configuring-environments).
...
- [Build and deploy](/docs/ai-control-plane/connect/sources/gram-functions/build-deploy) Gram Functions.
