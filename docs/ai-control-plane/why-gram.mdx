...
- [Building tools in TypeScript using Gram Functions](/docs/ai-control-plane/connect/sources/typescript)
- [Getting started with Gram using an API spec](/docs/ai-control-plane/connect/sources/openapi)
- [Bring an existing MCP server to Gram](/docs/ai-control-plane/connect/sources/gram-functions/mcp-sdk)
