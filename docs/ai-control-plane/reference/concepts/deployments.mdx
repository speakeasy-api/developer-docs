...
be exposed on an [MCP server](/docs/ai-control-plane/distribute/mcp-servers). If
a deployment includes updates to existing sources, any dependent tool
definitions and MCP servers are updated automatically.
