---
title: Concepts
description: "The core concepts behind the platform: tool sources, deployments, tool definitions, and tool variations."
asIndexPage: true
---

These pages describe the core concepts of the platform and how they fit together. Sources are deployed to generate tool definitions, selected tool definitions are served to agents as MCP servers, and tool variations refine how tools appear to LLMs along the way.
