...
description: "Stage a function zip file to a deployment configuration."
---

import { Callout } from '@/mdx/components'

The `gram stage function` command stages a function zip file to a deployment configuration.
...
This specifies the location of a zip file containing function code. It can be a local file or a URL.
