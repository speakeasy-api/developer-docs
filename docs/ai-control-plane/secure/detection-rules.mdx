...
The **Detection Rules** tab catalogs the detectors that power [guardrail policies](/docs/ai-control-plane/secure/guardrails). Open it from **Secure > Guardrails** in the dashboard and select the **Detection Rules** tab. Old links to the standalone Detection Rules page redirect to the tab.
