...
import bumpWithSpeakeasyOpenapiImage from '@/content/docs/assets/code-samples/bump-with-speakeasy-openapi.png'
import bumpAutomaticDeploymentSettingsImage from '@/content/docs/assets/code-samples/bump-automatic-deployment-settings.png'
