...
import bumpWithSpeakeasyOpenapiImage from '../assets/code-samples/bump-with-speakeasy-openapi.png'
import bumpAutomaticDeploymentSettingsImage from '../assets/code-samples/bump-automatic-deployment-settings.png'
...
<Screenshot 
  ...
  url="docs.myapi.com" 
  image={{
    src: bumpWithSpeakeasyOpenapiImage,
...
<Screenshot 
  ...
  image={{
    src: bumpAutomaticDeploymentSettingsImage,
