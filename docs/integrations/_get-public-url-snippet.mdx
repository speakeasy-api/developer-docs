...
import openapiRegistryAndCombinedSpecImage from '@/content/docs/assets/code-samples/openapi-registry-and-combined-spec.png'
import copyCombinedSpecUrlImage from '@/content/docs/assets/code-samples/copy-combined-spec-url.png'
