...
import scalarDocsUrlImportedImage from '@/content/docs/assets/code-samples/scalar-docs-url-imported.png'
import scalarReferenceToImportUrlImage from '@/content/docs/assets/code-samples/scalar-reference-to-import-url.png'
import scalarLinkOpenapiSpecificationModalImage from '@/content/docs/assets/code-samples/scalar-link-openapi-specification-modal.png'
