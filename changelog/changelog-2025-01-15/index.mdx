...
image: "/media/changelogs/changelog-2025-01-15.png"
date: 2025-01-15
authors:
  - name: Emre Tezisci
  - image_url: "/media/author-headshots/emre.jpeg"
featured_image: "/media/changelogs/changelog-2025-01-15.png"
---
...
<Table 
  data={[
    { customizationTool: "Overlays", purpose: "Modify the OpenAPI spec for structural or schema-related changes.", keyUseCase: "Adding paths, tweaking parameters, or updating models." },
    { customizationTool: "Hooks", purpose: "Intercept and modify SDK generation programmatically during the build.", keyUseCase: "Dynamic updates, injecting logic at specific stages." },
    { customizationTool: "Custom Code Regions", purpose: "Insert custom logic directly into the generated SDK code at runtime.", keyUseCase: "Adding helper methods, third-party integrations, or SDK-specific tweaks." }
  ]}  
  columns={[
    { key: "customizationTool", header: "Customization Tool" },
    { key: "purpose", header: "Purpose" },
    { key: "keyUseCase", header: "Key Use Case" }
  ]}
/>
...
import overlay_playground from "@/content/changelog/changelog-2025-01-15/assets/overlay-playground.mp4";
