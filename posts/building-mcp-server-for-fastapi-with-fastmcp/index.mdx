...
![FastMCP Installing MCP server](./assets/fastmcp-installing-mcp-server.png)
...
![Clicking on the search and tools button](./assets/mcp-server-search-and-tools-button.png)

Clicking on the button will display the MCP servers installed. The name of our MCP server will be `mcp_server`. 

![Selecting the MCP server](./assets/mcp-server-fastmcp-claude.png)

Clicking on the server, you will see the tools we added. 

![Listing the tools](./assets/mcp-server-fastmcp-claude-listing-tools.png)

You can then ask Claude to create a burger in the chat

![Creating a burger](./assets/claude-creating-a-burger.png)
...
![OpenAPI document path](./assets/speakeasy-openapi-path.png)

### 3. Naming the SDK

The next step is to give the SDK a name. Let's name the SDK `mcp-burger-sdk`.

![Choosing the SDK name](./assets/speakeasy-choosing-sdk-name.png)
...
![Choosing the SDK type](./assets/speakeasy-choosing-sdk-type.png)
...
![Viewing the MCP server](./assets/mcp-typescript-sdk.png)
