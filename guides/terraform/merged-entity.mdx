...
When an [x-speakeasy-entity-operation](/docs/terraform/customize-terraform/entity-mapping) is defined, the request body, parameters, and response bodies of `CREATE` and `READ` operations are considered the root of the Terraform Type Schema.
