...
sources:
    my-api:             👈 this is the name of the source used in `speakeasy configure sources`
        ...
        registry:
            location: registry.speakeasyapi.dev/your-company/your-company/my-api
        outputs:
...
* Use the registry URI as a source for generating SDKs, eg: `registry.speakeasyapi.dev/your-company/your-company/my-api`.
