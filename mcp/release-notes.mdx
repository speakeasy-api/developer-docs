...
<CodeWithTabs
  tabs={[
    {
      label: "Python",
      language: "python",
      code: `# Using official Python SDK - mcp package
  ...
  async def handle_list_tools() -> list[Tool]:
    ...
    },
    {
      label: "TypeScript",
      language: "typescript",
      code: `// Using official TypeScript SDK - @modelcontextprotocol/sdk package
...
<CodeWithTabs
  ...
  async def handle_call_tool(
      ...
      },
    {
      label: "TypeScript",
      language: "typescript",
        code: `server.setRequestHandler(CallToolRequestSchema, async (request, context) => {
    const { name, arguments: args } = request.params;
