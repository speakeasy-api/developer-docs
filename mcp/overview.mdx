---
title: "What is MCP?"
description: "A five-minute introduction to the Model Context Protocol: what MCP is, the problem it solves, and how AI agents use it to connect to tools and data."
---
...
- **Building AI agents**: [Introduction to AI agents](/mcp/using-mcp/ai-agents/introduction)
- **Creating MCP servers**: [Protocol deep dive](/mcp/core-concepts)

For a longer read, see our [in-depth introduction to using MCP](/blog/using-mcp-deep-dive). Once you're running more than a handful of servers, [an MCP gateway](/blog/what-is-an-mcp-gateway) gives you a single governed entry point for them. For how the pieces fit together — model calls, tool calls, and org-wide policy — see [AI gateway vs MCP gateway vs AI control plane](/blog/ai-gateway-vs-mcp-gateway-vs-ai-control-plane) and [what an AI control plane is](/resources/ai-control-plane).
