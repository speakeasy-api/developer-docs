...
Scroll to the **Visibility** section and set the server visibility to public. Under the **MCP Installation** section click on the **View** button to be redirected to the MCP installation page details.
...
Open the `claude_desktop_config.json` file, and paste the raw configuration you copied from Gram.
