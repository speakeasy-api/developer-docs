...
description: "A balanced, skeptical look at the Model Context Protocol: what MCP is good for, its real trade-offs, and when function calls or REST APIs are the better choice."
asIndexPage: true
---
...
<CardGrid
  ...
  cards={[
    ...
    },
    {
      ...
      href: "/mcp/overview#the-future-of-mcp",
      variant: "basic",
      icon: "trending-up",
    },
  ]}
