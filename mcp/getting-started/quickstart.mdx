...
import ClaudeConfigImage from "../assets/quickstart/claude-mcp-config.png";
import McpTestWebm from "../assets/quickstart/mcp-test.webm";
...
<video
  ...
  poster="../assets/quickstart/mcp-test-poster.png"
>
  <source src={McpTestWebm} type="video/webm" />
</video>
