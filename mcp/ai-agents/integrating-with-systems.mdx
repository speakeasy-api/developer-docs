...
<div className="mx-auto max-w-md py-4">
  ...
  API
  infrastructure](../assets/integrating-with-systems/website-integration.png)
</div>
...
<div className="mx-auto max-w-md py-4">
  ...
  retrieve insights](../assets/integrating-with-systems/data-analysis.png)
</div>
...
<div className="mx-auto max-w-md py-4">
  ...
  support](../assets/integrating-with-systems/collaborative-agents.png)
</div>
