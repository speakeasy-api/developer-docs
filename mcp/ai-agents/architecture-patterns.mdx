...
![A high-level diagram of the single-agent flow](../assets/architecture-patterns/single-agent-high-level.png)
...
![Diagram of the single-agent pattern](../assets/architecture-patterns/single-agent-architecture.png)
...
![Diagram of the memory-augmented agent pattern](../assets/architecture-patterns/single-agent-memory-augmented.png)
...
![Diagram of the tool-using agent pattern](../assets/architecture-patterns/single-agent-tool-using-architecture.png)
...
![Diagram of the planning-agent pattern](../assets/architecture-patterns/single-agent-planning-agent-architecture.png)
...
![Diagram of the reflection-agent pattern](../assets/architecture-patterns/single-agent-reflection-architecture.png)
...
![High-level diagram of the multi-agent flow](../assets/architecture-patterns/multi-agent-high-level.png)
...
![Diagram of the practical application of the supervisor pattern in a specialist appointment system for a hospital](../assets/architecture-patterns/multi-agent-supervisor-pattern.png)
...
![Diagram of the hierarchical pattern](../assets/architecture-patterns/multi-agent-hierarchical-architecture.png)
...
![Diagram of the competitive pattern](../assets/architecture-patterns/multi-agent-competitive-architecture.png)
...
![Diagram of the network pattern](../assets/architecture-patterns/multi-agent-network-architecture.png)
