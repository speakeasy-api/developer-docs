...
We'll build an MCP server with each tool using the [APItizing Burgers example project](https://github.com/speakeasy-api/examples/tree/main/framework-fastapi).
...
With Speakeasy, you can [customize your MCP server](/docs/standalone-mcp/customize-tools) using the `x-speakeasy-mcp` extension in your OpenAPI document.
