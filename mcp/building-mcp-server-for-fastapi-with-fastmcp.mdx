...
For this article, we are building an MCP server using the Apitizing Burgers API project that you can find [here](https://github.com/speakeasy-api/apitizing-burgers). Clone the project with the following command:
  ...
  "mcpServers": {
    "mcp_server": {
      ...
      "args": [
        ...
        "fastmcp",
        "run",
        "/Users/koladev/ritza/apitizing-burgers/app/mcp_server.py"
      ]
    }
  }
}
