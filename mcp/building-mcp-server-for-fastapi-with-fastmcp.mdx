...
<Screenshot url="url/here">![FastMCP Installing MCP server](./assets/building-mcp-server-for-fastapi-with-fastmcp/fastmcp-installing-mcp-server.png)</Screenshot>
...
<Screenshot url="url/here">![Clicking on the search and tools button](./assets/building-mcp-server-for-fastapi-with-fastmcp/mcp-server-search-and-tools-button.png)</Screenshot>

Clicking on the **Search and tools** button will display the MCP servers installed. Your MCP server's name will be `mcp_server`.


<Screenshot url="url/here">![Selecting the MCP server](./assets/building-mcp-server-for-fastapi-with-fastmcp/mcp-server-fastmcp-claude.png)</Screenshot>

Click on the server to see the tools you added.


<Screenshot url="url/here">![Listing the tools](./assets/building-mcp-server-for-fastapi-with-fastmcp/mcp-server-fastmcp-claude-listing-tools.png)</Screenshot>
...
<Screenshot url="url/here">![Creating a burger](./assets/building-mcp-server-for-fastapi-with-fastmcp/claude-creating-a-burger.png)</Screenshot>
...
<Screenshot url="url/here">![OpenAPI document path](./assets/building-mcp-server-for-fastapi-with-fastmcp/speakeasy-openapi-path.png)</Screenshot>
...
<Screenshot url="url/here">![Choosing the SDK name](./assets/building-mcp-server-for-fastapi-with-fastmcp/speakeasy-choosing-sdk-name.png)</Screenshot>
...
<Screenshot url="url/here">![Choosing the SDK type](./assets/building-mcp-server-for-fastapi-with-fastmcp/speakeasy-choosing-sdk-type.png)</Screenshot>
...
<Screenshot url="url/here">![Viewing the MCP server](./assets/building-mcp-server-for-fastapi-with-fastmcp/mcp-server-claude.png)</Screenshot>
