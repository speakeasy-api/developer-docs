...
- **[MCP tools](/mcp/core-concepts/tools):** Learn about tool registration and the request-response format.
- **[MCP resources](/mcp/core-concepts/resources):** Review resource URI schemes and MIME types.
- **[MCP transports](/mcp/core-concepts/transports):** Read about the host-to-server connection established before app negotiation begins.
