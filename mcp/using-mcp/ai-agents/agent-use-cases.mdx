...
- [Introduction to AI agents](/mcp/using-mcp/ai-agents/introduction)
- [Agent architecture](/mcp/using-mcp/ai-agents/architecture-patterns)

Once these agents are running across your organization, an [agent control plane](/resources/agent-control-plane) gives you a single place to govern and secure them.
