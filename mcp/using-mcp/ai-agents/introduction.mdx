...
![Assistant interaction flow](/assets/mcp/using-mcp/ai-agents/introductionduction/assistant-interaction-flow.gif)
...
![AI Agent](/assets/mcp/using-mcp/ai-agents/introductionduction/ai-agent.png)
...
![Agent interaction flow](/assets/mcp/using-mcp/ai-agents/introductionduction/agent-interaction-flow.gif)
...
OpenAI released a research preview of [Operator](https://openai.com/index/introducing-operator/), an agent that can browse the web to perform tasks by using OpenAI's [Computer-Using Agent](https://openai.com/index/computer-using-agent/). We can classify the OpenAI Operator as a type of operator.
...
![Operator interaction flow](/assets/mcp/using-mcp/ai-agents/introductionduction/operator-interaction-flow.gif)
...
![AI systems summary](/assets/mcp/using-mcp/ai-agents/introductionduction/ai-systems-summary.png)
...
![MCP](/assets/mcp/using-mcp/ai-agents/introductionduction/mcp.png)
...
[guide to building an MCP server for Discord](https://www.speakeasy.com/blog/build-a-mcp-server-tutorial). We demonstrate how to create an MCP server that connects with the Discord API, enabling it to read, send, and add reactions to specific messages. For educational purposes, we guide you through developing a server by hand.
...
To govern a fleet of agents in production, see the [agent control plane](/resources/agent-control-plane) and [AI agent hooks](/resources/ai-agent-hooks), the runtime interface for enforcing policy on agents like Claude Code, Cursor, and Copilot.
