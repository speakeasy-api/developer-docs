...
<video
  ...
  muted={true}
>
  <source src="/assets/videos/mcp/use-cases/postiz-mcp-demo.mp4" type="video/mp4" />
</video>
...
![Adding social media channel](/assets/mcp/using-mcp/social-media-postiz/postiz-add-channel-button.png)

Postiz displays the social media options you can connect to. For this guide, use X and LinkedIn.

![Social media options](/assets/mcp/using-mcp/social-media-postiz/postiz-social-media-options.png)
...
![Copying MCP SSE link](/assets/mcp/using-mcp/social-media-postiz/postiz-mcp-config.png)
...
![Adding a Custom Connector](/assets/mcp/using-mcp/social-media-postiz/postiz-adding-postiz-mcp-to-claude.png)
...
![Verifying Postiz config](/assets/mcp/using-mcp/social-media-postiz/postiz-config-verification.png)

Then, Claude schedules the posts. Click the generated links to view your scheduled posts in Postiz.

![Viewing a scheduled post](/assets/mcp/using-mcp/social-media-postiz/postiz-scheduled-post-view.png)
