...
The Slack MCP Server supports reactions in its current releases. This guide builds it from source so you can customize it for your workflows, but you can also install a [prebuilt binary or DXT extension](https://github.com/korotovsky/slack-mcp-server/releases) if you'd rather not compile it yourself.
