...
For example, [Gram's implementation of MCP](/docs/gram/concepts/environments) allows for environment-specific tool access and the ability to define different credentials and server URLs for different environments.
