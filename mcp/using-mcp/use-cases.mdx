...
Windsurf took a different approach with its IDE. Windsurf Wave 3 includes MCP support, allowing Cascade to connect to multiple servers simultaneously. The configuration is straightforward:
