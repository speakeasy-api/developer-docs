...
![A screenshot of the Cursor Settings interface shows a warning about exceeding the total tools limit, which is quoted below.](../assets/using-tools/cursor-limit.png)
