...
![Tweet from Armin Ronacher](/assets/mcp/playwright-tool-proliferation/armin-tweet.png)
...
![Playwright MCP architecture](/assets/mcp/playwright-tool-proliferation/playwright-mcp-architecture.png)
...
![Playwright MCP tools in VS Code](/assets/mcp/playwright-tool-proliferation/vscode-playwright.png)
...
![Inefficient Playwright workflow with too many tools](/assets/mcp/playwright-tool-proliferation/playwright-mcp-inefficient.png)
...
![Efficient Playwright workflow with curated tools](/assets/mcp/playwright-tool-proliferation/playwright-mcp-efficient.png)
...
![Claude search for 'Claude MCP servers' on Google](/assets/mcp/playwright-tool-proliferation/claude-search-google.png)
...
For more on how tool count affects LLM performance across different models and use cases, see our guide: [Why less is more for MCP](/mcp/building-servers/less-is-more). The guide presents research showing that LLMs start to struggle at around 30 tools for large models and just 19 tools for smaller models.
...
![VS Code tool limit](/assets/mcp/playwright-tool-proliferation/vscode-tool-limit.png)
