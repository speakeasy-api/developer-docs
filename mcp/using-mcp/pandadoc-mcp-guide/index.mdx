...
```txt
Create a short scrum report regarding tasks advancement. Then create a document in PandaDoc with the Progress Report template and fill it with the scrum report. Then, publish and share the document with an_email_address_com.
```
