...
![A high-level diagram of the single-agent flow](./assets/single-agent-high-level.png)
...
![Diagram of the single-agent pattern](./assets/single-agent-architecture.png)
...
![Diagram of the memory-augmented agent pattern](./assets/single-agent-memory-augmented.png)
...
![Diagram of the tool-using agent pattern](./assets/single-agent-tool-using-architecture.png)
...
![Diagram of the planning-agent pattern](./assets/single-agent-planning-agent-architecture.png)
...
![Diagram of the reflection-agent pattern](./assets/single-agent-reflection-architecture.png)
...
![High-level diagram of the multi-agent flow](./assets/multi-agent-high-level.png)
...
![Diagram of the practical application of the supervisor pattern in a specialist appointment system for a hospital](./assets/multi-agent-supervisor-pattern.png)
...
![Diagram of the hierarchical pattern](./assets/multi-agent-hierarchical-architecture.png)
...
![Diagram of the competitive pattern](./assets/multi-agent-competitive-architecture.png)
...
![Diagram of the network pattern](./assets/multi-agent-network-architecture.png)
