...
![Cloudflare Worker error page displaying TypeError exception](/assets/mcp/intro-in-depth/cloudflare-error.png)
...
In VS Code, with Cline installed, follow the steps below:
    ...
    ![Cline VS Code extension showing the MCP servers configuration panel](/assets/mcp/intro-in-depth/cline-setup.png)
...
![Sentry OAuth authorization page for Remote MCP server access](/assets/mcp/intro-in-depth/sentry-auth.png)
...
![Configuring the GitHub MCP server in Cline's settings panel](/assets/mcp/intro-in-depth/github-setup.png)
...
![Sentry error details showing the stack trace and TypeError](/assets/mcp/intro-in-depth/sentry-error-details.png)
...
![GitHub issue created about the Sentry error](/assets/mcp/intro-in-depth/github-issue.png)
...
![GitHub PR showing the bug fix about Sentry issue](/assets/mcp/intro-in-depth/github-pr.png)
...
![Fixed Cloudflare Worker successfully serving Hello World response](/assets/mcp/intro-in-depth/fixed-worker.png)
