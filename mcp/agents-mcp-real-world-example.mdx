...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/notion-key.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/notion-list-tasks.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/claude-add-tasks.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/blender-addon.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/blender-connect.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/blender-coffee-table.mp4" type="video/mp4" />
</video>
