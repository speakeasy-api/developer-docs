...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/agents-example/notion-list-tasks.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/agents-example/claude-add-tasks.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/agents-example/blender-addon.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/agents-example/blender-connect.mp4" type="video/mp4" />
</video>
...
<video controls={false} loop={true} autoPlay={true} muted={true} width="100%" className="mt-10">
  <source src="/assets/videos/agents-example/blender-coffee-table.mp4" type="video/mp4" />
</video>
