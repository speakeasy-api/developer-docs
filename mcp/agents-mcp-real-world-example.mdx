...
import { Callout , ReactPlayer } from "@/mdx/components";
...
<ReactPlayer 
  ...
  loop={true} 
  playing={true} 
  url={video_blender_coffee_table} 
  width="100%" 
  height="auto"
  volume={0}
  className="mt-10"
