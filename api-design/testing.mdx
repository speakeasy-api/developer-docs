...
<p className="typography-body-md whitespace-normal text-body">
  <ImageZoom src="/assets/api-design/pyramid.svg" alt="The test pyramid" width={500} height={400} />
</p>
...
<p className="typography-body-md whitespace-normal text-body">
  <ImageZoom src="/assets/api-design/api-pyramid.svg" alt="API test pyramid" width={500} height={400} />
</p>
