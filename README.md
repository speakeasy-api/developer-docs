...
- Use the `<CH.Scrollycoding>` [component](https://v0.codehike.org/demo/scrollycoding) for long code blocks or code overviews. This component allows users to scroll through the code block.
...
- Follow our [Screenshot Guide](https://www.notion.so/Screenshot-Guide-Docs-214edc98bf1f4a908b5fd7698f1e45ee?pvs=21) for details on formatting and creating effective screenshots.
...
Some company names use irregular capitalization rules. We've compiled a list of common examples [here](https://styleguide.ritza.co/grammar/grammar/vocabulary/brandnames), but you should check the company website to confirm their preferred formatting if there's any doubt.
