...
description: "How to secure an API with OpenAPI: define security schemes and security requirements at the document and operation level, from API keys to OAuth 2.0."
asIndexPage: true
---
