...
<Table
  data={[
    ...
    {
      field: "`callbacks`",
      type: "Map[string, [Callback Object](/openapi/webhooks/callbacks#callback-object-in-openapi) \\| [OpenAPI Reference Object](/openapi/references#openapi-reference-object)]*",
      description:
        "A map of [Callback Objects](/openapi/webhooks/callbacks#callback-object-in-openapi) that can be referenced by other parts of the API.",
    },
    {
      field: "`links`",
