...
description: "How to define OpenAPI Response Objects: status codes, media types, headers, and links that describe every possible outcome of an API operation."
asIndexPage: true
---
