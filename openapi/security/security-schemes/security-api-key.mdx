<<<<<<< HEAD:openapi-hub/security/security-schemes/security-api-key.mdx
...
# API Key Security Scheme in OpenAPI
>>>>>>> 31ce93d05fbe2d7bdd257ecbdb67c080032812be:openapi/security/security-schemes/security-api-key.mdx
