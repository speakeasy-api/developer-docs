...
description: "How to use the OpenAPI servers array to declare base URLs for production, staging, and sandbox environments — including server variables and URL templating."
asIndexPage: true
---
