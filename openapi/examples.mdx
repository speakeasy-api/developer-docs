---
title: "Examples in OpenAPI best practices"
description: "Enhance your API documentation with well-crafted Examples in OpenAPI to demonstrate request and response payloads for faster developer onboarding."
---
...
<Table
  data={[
    { field: "`summary`", type: "String", required: "", description: "A brief summary of the example." },
    { field: "`description`", type: "String", required: "", description: "A detailed description of the example. This may contain [CommonMark syntax](https://spec.commonmark.org/) to provide a rich description." },
    { field: "`value`", type: "Any (typically object)", required: "", description: "The example value. This field can contain any valid JSON data, including simple values or complex objects with multiple properties, as shown in the example below. Mutually exclusive with the `externalValue` field." },
    { field: "`externalValue`", type: "String", required: "", description: "A URL that points to the example. This is useful if the example is too large to include inline. Mutually exclusive with the `value` field." },
    { field: "`x-*`", type: "[Extensions](/openapi/extensions)", required: "", description: "Any number of extension fields can be added to the Example Object that can be used by tooling and vendors." }
  ]}
  columns={[
