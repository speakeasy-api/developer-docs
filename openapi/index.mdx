...
{/* Shared WebGL/ASCII canvas that renders the hero's <WebGLVideo> as ASCII —
    the docs frame doesn't include it (only the Marketing layout does), so the
    hub pages mount it themselves (see docs/index.mdx, docs/mcp/index.mdx). */}
