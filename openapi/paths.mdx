...
description: "How the OpenAPI Paths Object maps URL templates to operations, including path templating, Path Item Objects, and best practices for structuring API paths."
asIndexPage: true
---
