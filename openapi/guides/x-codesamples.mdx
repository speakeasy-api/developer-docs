---
title: "What is the code samples extension?"
  ...
  data={[
    {
      ...
      type: "string",
      description:
        "The language of the code snippet. Can be one from this [list](https://github.com/github-linguist/linguist/blob/master/lib/linguist/popular.yml).",
      required: "Yes",
    },
    {
      fieldName: "label",
      type: "string",
      description:
        "Code sample label, for example, `Node` or `Python3`. The `lang` value is used by default.",
      required: "No",
    },
    {
      fieldName: "source",
