...
description: "How to define OpenAPI Operation Objects: set operationId, parameters, request bodies, responses, and metadata for each HTTP method on a path."
---
...
<Table
  ...
  data={[
    ...
    {
      field: "`callbacks`",
      type: "[Callbacks](/openapi/webhooks/callbacks)",
      required: "",
      description: "A map of [Callback Objects](/openapi/webhooks/callbacks#callback-object-in-openapi) that define possible callbacks that may be executed as a result of this operation."
    }
  ]}
  columns={[
    {
