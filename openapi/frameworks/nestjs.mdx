...
After the basic route and schema structure is in place, add the parts that most directly affect SDK behavior: authentication and [retry behavior](/docs/sdks/customize/runtime/retries/).
