...
description: "A guide to OpenAPI Schema Objects and data types — strings, numbers, booleans, arrays, objects, enums, and null — for modeling API request and response data."
asIndexPage: true
---
