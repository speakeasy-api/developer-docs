---
title: XML Objects
description: "How to use the OpenAPI XML Object to control how schemas serialize to XML — element and attribute names, namespaces, prefixes, and wrapped arrays."
---
