...
Several tools will convert HAR to an OpenAPI schema. We'll use APIGit.
...
[Goa](https://github.com/goadesign/goa?tab=readme-ov-file) is a meta-framework that allows you to write an API design in Go code, which it then compiles into web server code and an OpenAPI schema.
