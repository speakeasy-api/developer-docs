...
<Table 
  data={[
    { useCase: "MVP with limited resources", requirements: "Quick setup, simplicity, flexibility", recommendedFrameworks: "Flask-RESTX, FastAPI" },
    { useCase: "Complex project", requirements: "Scalability, structure, robust tools", recommendedFrameworks: "Django + DRF" },
    { useCase: "Secure enterprise application", requirements: "Strong security, maintainability, scalability", recommendedFrameworks: "Django + DRF" },
    { useCase: "Fully async workload", requirements: "High concurrency, non-blocking performance", recommendedFrameworks: "FastAPI, Tornado" },
    { useCase: "Real-time application", requirements: "WebSocket support, low latency", recommendedFrameworks: "Tornado, Sanic" },
    { useCase: "Existing project", requirements: "Gradual migration to async or scaling needs", recommendedFrameworks: "Django (with ASGI), FastAPI" }
  ]}
  columns={[
    { key: "useCase", header: "Use case" },
    { key: "requirements", header: "Requirements" },
    { key: "recommendedFrameworks", header: "Recommended frameworks" }
  ]}
/>
