...
<Table 
  data={[
    { problem: "Inconsistent environments", solution: "Promotes consistency across dev, staging, and production environments." },
    { problem: "Managing multicloud infrastructure", solution: "Provides a unified framework for managing GCP, AWS, Azure, and more." },
    { problem: "Scalability challenges", solution: "Automates provisioning and management of resources, aiding scalability." },
    { problem: "Wasted cloud resources", solution: "Includes modules to estimate infrastructure cost and scale down unused resources." },
    { problem: "Resource orchestration", solution: "Automatically handles dependencies between infrastructure resources." },
    { problem: "Auditing and versioning of infrastructure", solution: "Enables version control and auditing of infrastructure." }
  ]}
  columns={[
    { key: "problem", header: "Infrastructure Problem" },
    { key: "solution", header: "Terraform Solution" }
  ]}
/>
...
<Table 
  data={[
    { language: "Go", files: "3024", lines: "267623", blank: "35706", comment: "10727", code: "221190", complexity: "37484", bytes: "9886221" },
    { language: "Markdown", files: "240", lines: "17985", blank: "6760", comment: "0", code: "11225", complexity: "0", bytes: "802305" },
    { language: "YAML", files: "5", lines: "65577", blank: "8", comment: "24", code: "65545", complexity: "0", bytes: "2170810" },
    { language: "JSON", files: "1", lines: "6", blank: "0", comment: "0", code: "6", complexity: "0", bytes: "83" },
    { language: "Makefile", files: "1", lines: "9", blank: "3", comment: "0", code: "6", complexity: "0", bytes: "138" },
    { language: "Terraform", files: "1", lines: "85", blank: "10", comment: "0", code: "75", complexity: "2", bytes: "2106" },
    { language: "gitignore", files: "1", lines: "4", blank: "0", comment: "0", code: "4", complexity: "0", bytes: "44" },
    { language: "Total", files: "3273", lines: "351289", blank: "42487", comment: "10751", code: "298051", complexity: "37486", bytes: "12861707" }
  ]}
  columns={[
