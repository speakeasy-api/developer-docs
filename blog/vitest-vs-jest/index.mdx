...
<Table 
  data={[
    { feature: "Battle tested by large companies", jest: "✅", vitest: "❌" },
    { feature: "ES module support", jest: "✅*", vitest: "✅" },
    { feature: "TypeScript support", jest: "✅+", vitest: "✅" },
    { feature: "Browser UI", jest: "❌", vitest: "✅*" },
    { feature: "Type testing", jest: "❌", vitest: "✅*" },
    { feature: "Benchmarking", jest: "❌", vitest: "✅" },
    { feature: "In-source testing", jest: "❌", vitest: "✅" },
    { feature: "Browser mode", jest: "❌", vitest: "✅*" },
    { feature: "Multi-browser support", jest: "❌", vitest: "✅" },
    { feature: "Enhanced error matching", jest: "❌", vitest: "✅" },
    { feature: "Project-level configuration", jest: "✅", vitest: "✅**" },
    { feature: "Snapshot testing", jest: "✅", vitest: "✅" },
    { feature: "Interactive snapshot testing", jest: "✅", vitest: "❌" },
    { feature: "Code coverage", jest: "✅", vitest: "✅" },
    { feature: "Concurrent testing", jest: "✅*", vitest: "✅" },
    { feature: "Sharding support", jest: "✅", vitest: "✅" }
  ]}
  columns={[
    { key: "feature", header: "Feature" },
    { key: "jest", header: "Jest" },
    { key: "vitest", header: "Vitest" }
  ]}
/>
...
<Callout title="Early access" type="info">
