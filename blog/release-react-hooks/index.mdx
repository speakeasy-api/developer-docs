...
<Callout title="Preview Availability" >
...
Here's an example using the [infinite query](https://tanstack.com/query/v5/docs/framework/react/guides/infinite-queries) version of a React hook: 
