...
[Rollup](https://rollupjs.org/), [Webpack](https://webpack.js.org/), [ESBuild](https://esbuild.github.io/),
[Turbopack](https://turbo.build/pack/docs). Bundlers are responsible for a bunch of tasks including
...
[minifying][/post/writing-zod-code-that-minifies] the code, splitting a bundle into smaller parts to load
