...
<Table 
  data={[
    { openapiVersion: "[3.0.0](https://spec.openapis.org/oas/v3.0.0)", date: "2017-07", notes: "Callbacks added" },
    { openapiVersion: "[3.0.1](https://spec.openapis.org/oas/v3.0.1)", date: "2017-12", notes: "" },
    { openapiVersion: "[3.0.2](https://spec.openapis.org/oas/v3.0.2)", date: "2018-10", notes: "" },
    { openapiVersion: "[3.0.3](https://spec.openapis.org/oas/v3.0.3)", date: "2020-02", notes: "" },
    { openapiVersion: "[3.1.0](https://spec.openapis.org/oas/v3.1.0)", date: "2021-02", notes: "Webhooks added" }
  ]}
  columns={[
    { key: "openapiVersion", header: "OpenAPI Version" },
