...
import video_url from "@/content/blog/release-speakeasy-suggest/assets/speakeasy-suggest-demo.mp4";
...
<Table 
  data={[
    { validationError: "duplicate operationId fields within same tag", suggestion: "Change value of offending operationId's", explanation: "Compiles without method names conflicting to get a functional SDK" },
    { validationError: "duplicate inline object schemas", suggestion: "Move to shared component", explanation: "Much shorter and more human-looking class names" },
    { validationError: "missing examples", suggestion: "Add examples for parameter, request bodies, responses, etc.", explanation: "Generated usage snippets are more human-looking" }
  ]}
  columns={[
    { key: "validationError", header: "Validation Error" },
