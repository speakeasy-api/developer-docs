...
<Table 
  data={[
    { feature: "Primary use case", speakeasy: "Automated SDK generation and management", prism: "API mocking and validation based on OpenAPI documents", mockServer: "HTTP/HTTPS request-response mocking and testing", postman: "API development, testing, and collaboration" },
    { feature: "SDK generation", speakeasy: "✅ Yes (automated SDK generation)", prism: "❌ No", mockServer: "❌ No", postman: "❌ No" },
    { feature: "Test generation", speakeasy: "✅ Yes", prism: "❌ No", mockServer: "❌ No", postman: "✅ Yes (pre-saved tests)" },
  ]}
  columns={[
    { key: "feature", header: "Feature" },
    { key: "speakeasy", header: "Speakeasy" },
    { key: "prism", header: "Prism" },
    { key: "mockServer", header: "MockServer" },
