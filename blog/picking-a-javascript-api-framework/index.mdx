...
<Table 
  data={[
    { scenario: "MVP with limited resources", recommendedFramework: "Hono, Fastify", why: "Lightweight, fast, and easy to set up. It is ideal for rapid iteration and serverless deployments." },
    { scenario: "Enterprise-grade applications", recommendedFramework: "NestJS", why: "Provides a structured architecture, robust security, and maintainability for large-scale systems." },
    { scenario: "Heavily async workloads", recommendedFramework: "Fastify", why: "Optimized for high-throughput and non-blocking operations, outperforming Express in concurrency." },  
    { scenario: "Familiarity with Node.js tools", recommendedFramework: "Express", why: "A stable and well-documented ecosystem with extensive middleware options." },
    { scenario: "Experimenting with Bun", recommendedFramework: "ElysiaJS", why: "High performance with unique developer tools, leveraging Bun's runtime for cutting-edge projects." },
  ]}
  columns={[
    { key: "scenario", header: "Scenario" },
    { key: "recommendedFramework", header: "Recommended Framework" },
    { key: "why", header: "Why?" }
  ]}
/>
