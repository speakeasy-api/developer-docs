...
<Table 
  data={[
    { aspect: "Definition", api: "A set of rules and protocols for communication between software components", sdk: "A bundle of tools, libraries, and documentation to accelerate development" },
    { aspect: "Scope", api: "Focuses on how to send and receive data (often via HTTP/HTTPS)", sdk: "Provides prebuilt code, testing frameworks, and platform-specific support" },
    { aspect: "Implementation Detail", api: "Requires developers to handle requests, responses, and error handling manually", sdk: "Abstracts complexities with prewritten methods and classes" },
    { aspect: "Platform Dependency", api: "Typically platform- and language-agnostic (REST, GraphQL, gRPC, etc.)", sdk: "Often tied to a specific language or ecosystem (Android SDK, iOS SDK, etc.)" },
    { aspect: "Use Case", api: "Ideal for lightweight integration, direct control, or cross-platform scenarios", sdk: "Best for rapid development, built-in best practices, and platform-specific features" }
  ]}
  columns={[
    { key: "aspect", header: "Aspect" },
    { key: "api", header: "API (Application Programming Interface)" },
    { key: "sdk", header: "SDK (Software Development Kit)" }
  ]}
/>
