...
<Callout title="Announcing: OpenAPI Reference" >
...
<Table 
  data={[
    { type: "string", format: "date", explanation: "An [RFC3339](https://www.rfc-editor.org/rfc/rfc3339#section-5.6) formatted date string", example: "\"2022-01-30\"" },
    { type: "string", format: "date-time", explanation: "An [RFC3339](https://www.rfc-editor.org/rfc/rfc3339#section-5.6) formatted date-time string", example: "\"2019-10-12T07:20:50.52Z\"" },
    { type: "string", format: "password", explanation: "Provides a hint that the string may contain sensitive information.", example: "\"mySecretWord1234\"" },
    { type: "string", format: "byte", explanation: "Base-64 encoded data.", example: "\"U3BlYWtlYXN5IG1ha2VzIHdvcmtpbmcgd2l0aCBBUElzIGZ1biE=\"" },
    { type: "string", format: "binary", explanation: "Binary data, used to represent the contents of a file.", example: "\"01010101110001\"" }
  ]}
  columns={[
...
<Table 
  data={[
    { type: "number", format: "", explanation: "Any number integer/float at any precision.", example: "**10** or **1.9** or **9223372036854775807**" },
    { type: "number", format: "float", explanation: "32-bit floating point number.", example: "**1.9**" },
    { type: "number", format: "double", explanation: "64-bit floating point number.", example: "**1.7976931348623157**" },
    { type: "integer", format: "", explanation: "Any integer number.", example: "**2147483647** or **9223372036854775807**" },
    { type: "integer", format: "int32", explanation: "32-bit integer.", example: "**2147483647**" },
    { type: "integer", format: "int64", explanation: "64-bit integer.", example: "9223372036854775807" }
  ]}
  columns={[
    { key: "type", header: "Type" },
    { key: "format", header: "Format" },
