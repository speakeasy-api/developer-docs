...
<Table 
  data={[
    { featureCategory: "Account Management", description: "Creation and synchronization of accounts across all platforms and devices", platforms: "[LootLocker](https://lootlocker.com/), [Pragma](https://pragma.gg/)" },
    { featureCategory: "Game Synchronization", description: "Ensure that all players would see the same game state at the same time, managing network speeds and latencies", platforms: "[Photon](https://doc.photonengine.com/pun/current/gameplay/rpc/), [Mirror](https://mirror-networking.com/)" },
    { featureCategory: "Matchmaking", description: "Creating a system that matched players based on skill level, geographical location, and latency", platforms: "[Beamable](https://beamable.com/), [Pragma](https://pragma.gg/), [PlayFab](https://playfab.com/)" },
    { featureCategory: "Games Server Orchestration", description: "Load balancing, game lifecycle management, and fleet management", platforms: "[Hathora](https://hathora.dev/), [Multiplay](https://unity.com/products/multiplay)" }
  ]}
  columns={[
    { key: "featureCategory", header: "Feature Category" },
