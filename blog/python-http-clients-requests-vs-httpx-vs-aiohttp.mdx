...
<Table 
  data={[
    { feature: "Synchronous operations", requests: "✅", aiohttp: "❌", httpx: "✅" },
    { feature: "Asynchronous operations", requests: "❌", aiohttp: "✅", httpx: "✅" },
    { feature: "Built-in HTTP/2 support", requests: "❌", aiohttp: "❌", httpx: "✅" },
    { feature: "WebSocket support", requests: "❌", aiohttp: "✅", httpx: "Via addon" },
    { feature: "Type hints", requests: "Partial", aiohttp: "✅", httpx: "✅" },
    { feature: "Retries with backoff", requests: "Via addon", aiohttp: "✅", httpx: "✅" },
    { feature: "SOCKS proxies", requests: "Via addon", aiohttp: "Via addon", httpx: "✅" },
    { feature: "Event hooks", requests: "✅", aiohttp: "❌", httpx: "✅" },
    { feature: "Brotli support", requests: "Via addon", aiohttp: "✅", httpx: "✅" },
    { feature: "Asynchronous DNS lookup", requests: "❌", aiohttp: "✅", httpx: "✅" }
  ]}
  columns={[
    { key: "feature", header: "Feature / Characteristic" },
    { key: "requests", header: "Requests" },
    { key: "aiohttp", header: "AIOHTTP" },
    { key: "httpx", header: "HTTPX" }
  ]}
/>
